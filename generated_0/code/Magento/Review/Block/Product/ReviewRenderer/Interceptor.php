...
class Interceptor extends \Magento\Review\Block\Product\ReviewRenderer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function isReviewEnabled() : string
    {
        ...
        if (!$pluginInfo) {
            return parent::isReviewEnabled();
        } else {
            return $this->___callPlugins('isReviewEnabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getReviewsCount()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getReviewsCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getReviewsUrl($useDirectLink = false)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getReviewsUrl', func_get_args(), $pluginInfo);
        }
    }
