...
class Interceptor extends \Mageplaza\LayeredNavigation\Model\ResourceModel\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchEngine');
        if (!$pluginInfo) {
            return parent::getSearchEngine();
        } else {
            return $this->___callPlugins('getSearchEngine', func_get_args(), $pluginInfo);
        }
    }
