<?php
namespace Mageplaza\ProductFeed\Console\Command\Generate;

/**
 * Interceptor class for @see \Mageplaza\ProductFeed\Console\Command\Generate
 */
class Interceptor extends \Mageplaza\ProductFeed\Console\Command\Generate implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\Config\Storage\Writer $writer, \Mageplaza\ProductFeed\Helper\Data $helper, \Psr\Log\LoggerInterface $logger, \Mageplaza\ProductFeed\Model\FeedFactory $feedFactory, \Mageplaza\ProductFeed\Model\ResourceModel\Feed\CollectionFactory $collectionFactory, $name = null)
    {
        $this->___init();
        parent::__construct($writer, $helper, $logger, $feedFactory, $collectionFactory, $name);
    }
