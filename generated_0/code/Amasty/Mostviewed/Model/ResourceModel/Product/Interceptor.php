...
/**
 * Interceptor class for @see \Amasty\Mostviewed\Model\ResourceModel\Product
 */
class Interceptor extends \Amasty\Mostviewed\Model\ResourceModel\Product implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductViewesData');
        if (!$pluginInfo) {
            return parent::getProductViewesData($productId, $storeId, $period);
        } else {
            return $this->___callPlugins('getProductViewesData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBoughtTogetherProductData');
        if (!$pluginInfo) {
            return parent::getBoughtTogetherProductData($productIds, $storeId, $period, $orderStatus);
        } else {
            return $this->___callPlugins('getBoughtTogetherProductData', func_get_args(), $pluginInfo);
        }
    }
