<?php
namespace Amasty\Mostviewed\Block\Widget\Related;

/**
 * Interceptor class for @see \Amasty\Mostviewed\Block\Widget\Related
 */
class Interceptor extends \Amasty\Mostviewed\Block\Widget\Related implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Amasty\Mostviewed\Api\GroupRepositoryInterface $groupRepository, \Amasty\Mostviewed\Model\ProductProvider $productProvider, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Amasty\Mostviewed\Helper\Quote $quoteHelper, \Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, array $data = [])
    {
        $this->___init();
        parent::__construct($groupRepository, $productProvider, $catalogProductVisibility, $quoteHelper, $context, $productCollectionFactory, $data);
    }
    ...
    public function getCssClass()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCssClass', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBrandLogoHtml');
        if (!$pluginInfo) {
            return parent::getBrandLogoHtml($product);
        } else {
            return $this->___callPlugins('getBrandLogoHtml', func_get_args(), $pluginInfo);
        }
    }
