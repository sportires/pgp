<?php
namespace Ced\Amazon\Console\Order\Create;

/**
 * Interceptor class for @see \Ced\Amazon\Console\Order\Create
 */
class Interceptor extends \Ced\Amazon\Console\Order\Create implements \Magento\Framework\Interception\InterceptorInterface
{
