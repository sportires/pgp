<?php
namespace Ced\Amazon\Console\Migrate\Listing;

/**
 * Interceptor class for @see \Ced\Amazon\Console\Migrate\Listing
 */
class Interceptor extends \Ced\Amazon\Console\Migrate\Listing implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'm2epro');
        if (!$pluginInfo) {
            return parent::m2epro($profileId, $output);
        } else {
            return $this->___callPlugins('m2epro', func_get_args(), $pluginInfo);
        }
    }
