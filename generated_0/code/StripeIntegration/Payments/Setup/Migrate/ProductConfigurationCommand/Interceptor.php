...
class Interceptor extends \StripeIntegration\Payments\Setup\Migrate\ProductConfigurationCommand implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTrialDays');
        if (!$pluginInfo) {
            return parent::getTrialDays($unit, $frequency);
        } else {
            return $this->___callPlugins('getTrialDays', func_get_args(), $pluginInfo);
        }
    }
