...
class Interceptor extends \Smartwave\Megamenu\Block\Topmenu implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCategoryHelper()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCategoryHelper();
        } else {
            return $this->___callPlugins('getCategoryHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCategoryModel($id)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCategoryModel($id);
        } else {
            return $this->___callPlugins('getCategoryModel', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getChildCategories($category)
    {
        ...
        if (!$pluginInfo) {
            return parent::getChildCategories($category);
        } else {
            return $this->___callPlugins('getChildCategories', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getActiveChildCategories($category)
    {
        ...
        if (!$pluginInfo) {
            return parent::getActiveChildCategories($category);
        } else {
            return $this->___callPlugins('getActiveChildCategories', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockContent');
        if (!$pluginInfo) {
            return parent::getBlockContent($content);
        } else {
            return $this->___callPlugins('getBlockContent', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomBlockHtml');
        if (!$pluginInfo) {
            return parent::getCustomBlockHtml($type);
        } else {
            return $this->___callPlugins('getCustomBlockHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubmenuItemsHtml');
        if (!$pluginInfo) {
            return parent::getSubmenuItemsHtml($children, $level, $max_level, $column_width, $menu_type, $columns);
        } else {
            return $this->___callPlugins('getSubmenuItemsHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMegamenuHtml()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMegamenuHtml();
        } else {
            return $this->___callPlugins('getMegamenuHtml', func_get_args(), $pluginInfo);
        }
    }
