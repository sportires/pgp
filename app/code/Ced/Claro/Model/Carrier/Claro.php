...
namespace Ced\Claro\Model\Carrier;

use Magento\Quote\Model\Quote\Address\RateRequest;

class Claro extends \Magento\Shipping\Model\Carrier\AbstractCarrier implements
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    const SHIPPING_METHOD_CODE = "shipbyclaro";
    const SHIPPING_METHOD = "shipbyclaro_shipbyclaro";
