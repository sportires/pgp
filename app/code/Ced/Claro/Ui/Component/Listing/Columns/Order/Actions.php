...
namespace Ced\Claro\Ui\Component\Listing\Columns\Order;
...
class Actions extends Column
{
    ...
    const URL_PATH_VIEW = 'claro/order/view';
    const URL_PATH_SYNC = 'claro/order/sync';
    const URL_PATH_DELETE = 'claro/order/delete';
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['id'])) {
                    ...
                    $item[$name]['view'] = [
                        ...
                        'popup' => [
                            'title' => __("Claro Order #{$item['magento_increment_id']}"),
