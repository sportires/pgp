 ...
 */
class Validate extends \Ced\Claro\Controller\Adminhtml\Profile\Base
{
    public function execute()
    {
        $this->validation->setData('error', false);
        $this->validation->setData('messages', []);
        $valid = $this->validate(true);
        $this->validation->setData('error', !$valid);
        ...
        $resultPage->setData($this->validation->getData());
        return $resultPage;
    }
}
