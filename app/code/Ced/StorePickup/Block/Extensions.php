...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset  
{
    ...
    public function __construct(
        ...
        $this->_helper = $this->_objectManager->get('Ced\StorePickup\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
		...
		$modules =  $this->_objectManager->get('Ced\StorePickup\Helper\Feed')->getAllModules();
    ...
    {
    	$hash = \Ced\StorePickup\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_hash';	
    	$level = \Ced\StorePickup\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_level';

	 	$helper = $this->_objectManager->create('Ced\StorePickup\Helper\Data');
		...
		$l = $this->_objectManager->create('Ced\StorePickup\Helper\Feed')->getLicenseFromHash($hash,$level);
