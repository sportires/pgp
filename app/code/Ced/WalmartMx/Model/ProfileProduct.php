...
class ProfileProduct extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Ced\WalmartMx\Model\ResourceModel\ProfileProduct');
    }
    ...
    {
        return $this->getResource('Ced\WalmartMx\Model\ResourceModel\ProfileProduct\Collection');
    }
     ...
     * @return bool|\Ced\WalmartMx\Model\ProfileProduct
     */
