...
interface RequestInterface
{
     ...
     * Default API URLs
     */
    const WALMARTMX_API_URL = 'https://walmartmx-prod.mirakl.net/';
    const WALMARTMX_SANDBOX_API_URL = 'https://walmartmx-dev.mirakl.net/';
    ...
    const GET_ACCOUNT_SUB_URL = 'api/account';
