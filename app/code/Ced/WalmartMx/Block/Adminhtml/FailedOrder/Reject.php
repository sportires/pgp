...
namespace Ced\WalmartMx\Block\Adminhtml\FailedOrder;

class Reject extends \Magento\Backend\Block\Widget\Container
{
    ...
    {
        return $this->getUrl(
            'walmartmx/failedorder/index'
        );
    }

    public function getAjaxUrl()
    {
        return $this->getUrl('walmartmx/failedorder/reject');
    }
}
