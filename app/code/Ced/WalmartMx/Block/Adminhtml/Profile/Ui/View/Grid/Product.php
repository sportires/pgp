...
namespace Ced\WalmartMx\Block\Adminhtml\Profile\Ui\View\Grid;
...
class Product extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Ced\WalmartMx\Model\Source\Profiles $profiles,
        \Ced\WalmartMx\Model\Source\Categories $categories,
        array $data = []
    )
    {
    ...
    {
        parent::_construct();
        $this->setId('walmartmx_profile_products');
    ...
    {
        return $this->_coreRegistry->registry('walmartmx_profile');
    }
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'category_ids',
                'renderer' => 'Ced\WalmartMx\Block\Adminhtml\Profile\Ui\View\Grid\Category',
