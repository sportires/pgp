...
class ProfileProducts extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Ced_WalmartMx::profile/profile_products.phtml';
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                \Ced\WalmartMx\Block\Adminhtml\Profile\Ui\View\Grid\Product::class,
                'walmartmx.profile.products.grid'
            );
        }
 ...
 /**
    ...
    {
        return $this->registry->registry('walmartmx_profile');
    }
}
