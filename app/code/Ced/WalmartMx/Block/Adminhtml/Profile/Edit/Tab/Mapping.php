...
namespace Ced\WalmartMx\Block\Adminhtml\Profile\Edit\Tab;

use WalmartMxSdk\Product;
...
class Mapping extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('category', ['legend' => __('WalmartMx Category Listing')]);
        ...
        $locations->setRenderer(
            $this->getLayout()->createBlock('Ced\WalmartMx\Block\Adminhtml\Profile\Edit\Tab\Attribute\CategoryJs')
        );

        $fieldset = $form->addFieldset(
            'attributes_fieldset',
            [
                'legend' => __('WalmartMx Attributes Mapping')
            ]
        );
        ...
        $locations->setRenderer(
            $this->getLayout()->createBlock(
                'Ced\WalmartMx\Block\Adminhtml\Profile\Edit\Tab\Attribute\Attributes',
