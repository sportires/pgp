...
namespace Ced\WalmartMx\Controller\Adminhtml\FailedOrder;
 ...
 * Class Delete
 *
 * @package Ced\WalmartMx\Controller\Adminhtml\FailedOrder
 */
class Delete extends Action
{
     ...
     * @param \Ced\WalmartMx\Model\OrderFailed           $orderFailed
     */
    public function __construct(
        Action\Context $context,
        PageFactory $resultPageFactory,
        \Magento\Ui\Component\MassAction\Filter $filter,
        \Ced\WalmartMx\Model\OrderFailed $orderFailed
    ) {
    ...
    public function execute()
    {
        ...
        $this->_redirect('walmartmx/failedorder');
    }
}
