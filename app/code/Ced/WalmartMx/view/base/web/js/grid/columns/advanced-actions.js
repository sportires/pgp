...
define([
    ...
    'Ced_WalmartMx/js/modal/popup',
    'vkbeautify',
    'highlight'
], function ($, _, utils, registry, Column, confirm, popup, vk, highlight) {
    'use strict';

    return Column.extend({
        defaults: {
            bodyTmpl: 'Ced_WalmartMx/grid/cells/advanced-action',
            sortable: false,
            draggable: false,
            actions: [],
            rows: [],
        ...
        /**
         * Shows modal window.
         * @TODO implement loader, handle large file issue, optimize performance
         * @param {Object} action - Actions' data.
        ...
        _popup: function (action, callback) {
            ...
            var dataType = popupData.type === undefined || popupData.type === '' ? 'xml' : popupData.type;
