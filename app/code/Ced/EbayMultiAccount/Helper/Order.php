...
class Order extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getNewOrders($accountIds = array())
    {
        ...
        $realCustomer = $this->scopeConfig->getValue('ebaymultiaccount_config/ebaymultiaccount_order/ebaymultiaccount_customer/real_customer');
        $customerEmail = $this->scopeConfig->getValue('ebaymultiaccount_config/ebaymultiaccount_order/ebaymultiaccount_customer/customer_email');
        $customerName = $this->scopeConfig->getValue('ebaymultiaccount_config/ebaymultiaccount_order/ebaymultiaccount_customer/customer_name');
        $customerLastname = $this->scopeConfig->getValue('ebaymultiaccount_config/ebaymultiaccount_order/ebaymultiaccount_customer/customer_lastname');
    ...
    public function _assignCustomer($customer, $firstName, $lastName, $email, $websiteId, $result)
    {
        ...
        $realCustomer = $this->scopeConfig->getValue('ebaymultiaccount_config/ebaymultiaccount_order/ebaymultiaccount_customer/real_customer');
        $customerGroup = $this->scopeConfig->getValue('ebaymultiaccount_config/ebaymultiaccount_order/ebaymultiaccount_customer/customer_group');
        $customerPassword = $this->scopeConfig->getValue('ebaymultiaccount_config/ebaymultiaccount_order/ebaymultiaccount_customer/customer_password');
