...
namespace Customweb\FirstDataConnectCw\Helper;
...
class ExternalCheckout extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function validateCustomerData(\Magento\Quote\Model\Quote $quote, array $data, $registerMethod)
	{
		...
		if ($registerMethod == \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER) {
	...
	/**
	 * @param \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context
	 * @return \Magento\Sales\Model\Order
	 */
	public function saveOrder(\Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context)
	{
		$context->getQuote()->collectTotals()->save();

		$isNewCustomer = false;
		switch ($context->getRegisterMethod()) {
			case \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST:
				$this->prepareGuestQuote($context);
				break;
			case \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER:
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareGuestQuote(\Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareNewCustomerQuote(\Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context)
	{
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context
	 */
	private function prepareCustomerQuote(\Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context)
	{
		$billing = $context->getQuote()->getBillingAddress();
		$shipping = $context->getQuote()->isVirtual() ? null : $context->getQuote()->getShippingAddress();
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context
	 */
	private function involveNewCustomer(\Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context $context)
	{
		$customer = $context->getQuote()->getCustomer();
