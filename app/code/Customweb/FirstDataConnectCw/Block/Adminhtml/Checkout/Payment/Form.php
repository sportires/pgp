...
namespace Customweb\FirstDataConnectCw\Block\Adminhtml\Checkout\Payment;

class Form extends \Magento\Backend\Block\Widget
{
	/**
	 * @var \Customweb\FirstDataConnectCw\Model\Renderer\AdminhtmlForm
	 */
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer
	 * @param \Customweb\FirstDataConnectCw\Model\Authorization\Method\Factory $authorizationMethodFactory
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\FirstDataConnectCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer,
	...
	{
		if (!($this->transaction instanceof \Customweb\FirstDataConnectCw\Model\Authorization\Transaction)) {
	 ...
	 * @return \Customweb\FirstDataConnectCw\Block\Adminhtml\Checkout\Payment\Form
	 */
	public function setTransaction(\Customweb\FirstDataConnectCw\Model\Authorization\Transaction $transaction)
	{
