...
namespace Customweb\FirstDataConnectCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('firstdataconnectcw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('firstdataconnectcw_transaction');
	}
	...
	{
		return $this->getUrl('firstdataconnectcw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('firstdataconnectcw/transaction/');
	}
}