...
namespace Customweb\FirstDataConnectCw\Model\Authorization\Method;
...
abstract class AbstractMethod
{
	...
	/**
	 * @var \Customweb\FirstDataConnectCw\Model\Authorization\TransactionContextFactory
	 */
	...
	/**
	 * @var \Customweb\FirstDataConnectCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory
	 */
	protected $_transactionCollectionFactory;

	/**
	 * @var \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\Factory
	 */
	...
	/**
	 * @var \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext
	 */
	private $context;
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\Authorization\TransactionContextFactory $transactionContextFactory
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\Factory $contextFactory
	 * @param \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function __construct(
			...
			\Customweb\FirstDataConnectCw\Model\Authorization\TransactionContextFactory $transactionContextFactory,
			...
			\Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\Factory $contextFactory,
			\Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext $context
	...
	/**
	 * @return \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext
	 */
	public function getContext()
	{
		if (!($this->context instanceof \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext)) {
	 ...
	 * @param \Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function setContext(\Customweb\FirstDataConnectCw\Model\Authorization\Method\Context\IContext $context)
	{
		$this->context = $context;
	}
	...
	public function initializeTransaction(\Customweb\FirstDataConnectCw\Model\Authorization\Transaction $transaction)
	{
		
		$arguments = array(
			'transaction' => $transaction,
 		);
		return \Customweb_Licensing_FirstDataConnectCw_License::run('audru4srd8qs8b18', $this, $arguments);
	}

	final public function call_k6lr8prrlddh3s8g() {
	...
	/**
	 * @return \Customweb\FirstDataConnectCw\Model\Service\AuthorizationData
	 */
	public function startAuthorization()
	{
		$data = new \Customweb\FirstDataConnectCw\Model\Service\AuthorizationData();
	...
	public function finishAuthorization()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_FirstDataConnectCw_License::run('dli6bgide8c0e3nf', $this, $arguments);
	}

	final public function call_olstgbg1afi5oc60() {
		$arguments = func_get_args();
		$method = $arguments[0];
		$call = $arguments[1];
		$parameters = array_slice($arguments, 2);
	...
	/**
	 * @return \Customweb\FirstDataConnectCw\Model\Authorization\Transaction|null
	 */
	...
	{
		if ($this->getContext()->getPaymentMethod() instanceof \Customweb\FirstDataConnectCw\Model\Payment\Method\AbstractMethod) {
