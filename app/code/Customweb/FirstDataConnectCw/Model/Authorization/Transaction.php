...
namespace Customweb\FirstDataConnectCw\Model\Authorization;

use \Customweb\FirstDataConnectCw\Api\Data\TransactionInterface;
use Magento\Customer\Model\Customer;

/**
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setSendEmail(boolean $value)
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\FirstDataConnectCw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_firstdataconnectcw_transaction';
	 ...
	 * @var string
	 */
	protected $_entityType = 'fdccw_trx';
	...
	{
		$this->_init('Customweb\FirstDataConnectCw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\FirstDataConnectCw\Model\Authorization\CustomerContext) {
				try {
