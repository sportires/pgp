...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	...
	public function validate()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_FirstDataConnectCw_License::run('fnu3duk4bat5pm3j', $this, $arguments);
	}

	final public function call_5mh5t4mp761uq2ml() {
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		try {
			...
			if ($transaction->getId()) {
				$invoice = $this->_registry->registry('firstdataconnectcw_invoice');
