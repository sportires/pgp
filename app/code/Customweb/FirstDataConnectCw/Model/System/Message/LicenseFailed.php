...
class LicenseFailed implements \Magento\Framework\Notification\MessageInterface
{
        ...
        public function isDisplayed()
    {
		...
		$arguments = null;
		return \Customweb_Licensing_FirstDataConnectCw_License::run('pae66u44hm4m3e6i', $this, $arguments);
	}

	final public function call_l4n6g48ad3jaic0t() {
        ...
        public function getText()
    {
		...
		$arguments = null;
		return \Customweb_Licensing_FirstDataConnectCw_License::run('n91tbbe2nn3871rd', $this, $arguments);
	}

	final public function call_bghsl829tpo22imp() {
		$arguments = func_get_args();
		$method = $arguments[0];
		$call = $arguments[1];
		$parameters = array_slice($arguments, 2);
