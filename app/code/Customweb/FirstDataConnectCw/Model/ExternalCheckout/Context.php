...
namespace Customweb\FirstDataConnectCw\Model\ExternalCheckout;

/**
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_firstdataconnectcw_external_checkout_context';
    ...
    protected function _construct() {
        $this->_init('Customweb\FirstDataConnectCw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\FirstDataConnectCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\FirstDataConnectCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context
     */
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\FirstDataConnectCw\Model\Payment\Method\AbstractMethod) {
			$data = [
