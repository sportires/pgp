...
namespace Customweb\FirstDataConnectCw\Model\Renderer;
...
class FrontendForm extends AbstractForm
{
	...
	{
		parent::__construct();
		$this->setControlCssClassResolver(new \Customweb\FirstDataConnectCw\Model\Renderer\ControlCssClassResolver());
	}

	public function renderElementGroupPrefix(\Customweb_Form_IElementGroup $elementGroup)
	{
		return '<fieldset class="firstdataconnectcw_fieldset fieldset">';
	}
