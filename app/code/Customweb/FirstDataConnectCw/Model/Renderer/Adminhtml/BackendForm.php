...
namespace Customweb\FirstDataConnectCw\Model\Renderer\Adminhtml;

class BackendForm extends \Customweb\FirstDataConnectCw\Model\Renderer\AbstractForm
{
	...
	public function __construct(
		...
		$this->setFormCssClass('firstdataconnectcw_form');
