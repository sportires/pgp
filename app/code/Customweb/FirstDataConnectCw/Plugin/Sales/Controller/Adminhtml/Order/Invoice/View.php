...
namespace Customweb\FirstDataConnectCw\Plugin\Sales\Controller\Adminhtml\Order\Invoice;
...
class View
{
	...
	private function canCaptureNoClose()
	{
		...
		if (!($invoice->getOrder()->getPayment()->getMethodInstance() instanceof \Customweb\FirstDataConnectCw\Model\Payment\Method\AbstractMethod)) {
			return false;
		}
