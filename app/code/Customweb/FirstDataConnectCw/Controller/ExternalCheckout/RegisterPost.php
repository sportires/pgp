...
class RegisterPost extends \Customweb\FirstDataConnectCw\Controller\ExternalCheckout
{
	/**
	...
	public function execute()
	{
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER);
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\FirstDataConnectCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER))) {
