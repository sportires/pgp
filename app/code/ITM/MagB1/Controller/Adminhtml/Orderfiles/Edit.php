...
class Edit extends \ITM\MagB1\Controller\Adminhtml\Orderfiles
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('current_itm_magb1_orderfiles', $model);
        $this->_initAction();
        $this->_view->getLayout()->getBlock('orderfiles_orderfiles_edit');
