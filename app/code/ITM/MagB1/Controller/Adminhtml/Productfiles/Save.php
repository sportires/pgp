...
class Save extends \ITM\MagB1\Controller\Adminhtml\Productfiles
{
    ...
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                // save the file
                $destinationPath = $this->getDestinationPath().$data["sku"]."/";
                ...
                /*$this->messageManager->addError(
                    __('Something went wrong while saving the item data. '.$e->getMessage())
                );
                */
                $this->messageManager->addError(
                    __($e->getMessage())
