...
class Save extends \ITM\MagB1\Controller\Adminhtml\Categoryfiles
{
    protected $uploaderFactory;
    
    protected $helper;
    
    protected $allowedExtensions = ['csv','txt','pdf','zip','jpg','png'];
    ...
    public function execute()
    {
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                // save the file
                $destinationPath = $this->getDestinationPath()."/store_".$data["store_id"]."/".md5($data["code"])."/";
    ...
    {
        return $this->helper->getCategoryFilesPath();
    }
}
