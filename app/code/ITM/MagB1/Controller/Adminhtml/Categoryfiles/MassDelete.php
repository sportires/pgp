...
class MassDelete extends \ITM\MagB1\Controller\Adminhtml\Categoryfiles
{
    protected $helper;
        ...
        if (!is_array($itemsIds)) {
            ...
            try {
                foreach ($itemsIds as $itemId) {
                    ...
                    $model->delete();
                    // delete the file
                    $destinationPath = $this->getDestinationPath() ."store_". $model->getData("store_id") . "/".md5($model->getData("code"))."/";
