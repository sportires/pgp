...
namespace ITM\MagB1\Block\Adminhtml\Invoicefiles;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \ITM\MagB1\Model\ResourceModel\Invoicefiles\CollectionFactory $collectionFactory,
        //\ITM\MagB1\Model\ResourceModel\Invoicefiles\Collection $collectionFactory,
        Status $status,
        array $data = []
    ) {
